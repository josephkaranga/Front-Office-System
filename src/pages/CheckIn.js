  ...
  return (
    <>
      ...
      <div className="page-container">
        ...
        {/* ── New Guest Modal ── */}
        <Modal isOpen={showGuestModal} onClose={() => { setShowGuestModal(false); setDuplicates([]); setGuestError(''); }} title="Register New Guest" size="md">
          ...
          <form onSubmit={(e) => handleCreateGuest(e, duplicates.length > 0)} className="space-y-3">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button type="submit" className="btn-primary">
                {duplicates.length > 0 ? 'Create Anyway' : 'Register Guest'}
              </button>
            </div>
          </form>
        </Modal>
